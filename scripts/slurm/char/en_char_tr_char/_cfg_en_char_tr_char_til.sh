...
export MRL_NMT_BIN_DATA_FOLDER=/home/jonnesaleva/mrl_nmt22/data-bin/en-tr/en_char_tr_char/default-train/
...
export MRL_NMT_EVAL_MODEL_CHECKPOINT="/home/jonnesaleva/mrl_nmt22/experiments/en_char_tr_char_slurm/eval/eval_slurmformer_clipnorm0.1_500k/checkpoint"
export MRL_NMT_EVAL_MODE="test"
export MRL_NMT_EVAL_NAME="eval_slurmformer_clipnorm0.1_500k"
export MRL_NMT_EXPERIMENT_NAME=en_char_tr_char_slurm
...
export MRL_NMT_RAW_DATA_FOLDER=/home/jonnesaleva/datasets/mrl_nmt22/processed/en-tr/en_char_tr_char/default-train
export MRL_NMT_REFERENCES_FILE=/home/jonnesaleva/datasets/mrl_nmt22/processed/en-tr/en_char_tr_char/default-train/en-tr.test.detok.tr
