...
export MRL_NMT_EXPERIMENT_NAME=en_sp32k_uz_sp32k_slurm_sanevocab
...
export MRL_NMT_VALIDATE_INTERVAL_UPDATES=1000 # 500 -> 1000

# corpus: default-train
export MRL_NMT_BIN_DATA_FOLDER=/home/$(whoami)/mrl_nmt22/data-bin/en-uz/en_sp32k_uz_sp32k/default-train/
export MRL_NMT_EVAL_MODEL_CHECKPOINT="/home/$(whoami)/mrl_nmt22/experiments/en_sp32k_uz_sp32k_slurm/train/slurmformer_clipnorm0.1_20k_lr0.001/checkpoints/checkpoint_best.pt"
export MRL_NMT_EVAL_MODE="test"
export MRL_NMT_EVAL_NAME="eval_slurmformer_clipnorm0.1_20k_lr0.001"
export MRL_NMT_RAW_DATA_FOLDER=/home/$(whoami)/datasets/mrl_nmt22/processed/en-uz/en_sp32k_uz_sp32k/default-train
export MRL_NMT_REFERENCES_FILE=/home/$(whoami)/datasets/mrl_nmt22/processed/en-uz/en_sp32k_uz_sp32k/default-train/en-uz.test.detok.uz
