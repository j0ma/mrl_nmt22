...
export MRL_NMT_BATCH_SIZE=96
export MRL_NMT_BIN_DATA_FOLDER=/home/jonnesaleva/mrl_nmt22/data-bin/en-uz/en_char_uz_char/default-train/
...
export MRL_NMT_EVAL_MODEL_CHECKPOINT="/home/jonnesaleva/mrl_nmt22/experiments/en_char_uz_char/eval/eval_slurmformer_clipnorm0.1/checkpoint"
export MRL_NMT_EVAL_MODE="test"
export MRL_NMT_EVAL_NAME="eval_slurmformer_clipnorm0.1"
...
export MRL_NMT_MAX_TOKENS=4096
export MRL_NMT_MAX_UPDATES=150000
