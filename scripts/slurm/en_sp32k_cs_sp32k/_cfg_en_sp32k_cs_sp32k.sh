...
export MRL_NMT_EXPERIMENT_NAME=en_sp32k_cs_sp32k_slurm_sanevocab
...
export MRL_NMT_BIN_DATA_FOLDER=/home/$(whoami)/mrl_nmt22/data-bin/en-cs/en_sp32k_cs_sp32k/default-train/
export MRL_NMT_EVAL_MODE="test"
export MRL_NMT_EVAL_MODEL_CHECKPOINT="/home/jonnesaleva/mrl_nmt22/experiments/en_sp32k_cs_sp32k_slurm_sanevocab/train/slurmformer_clipnorm0.1_20k_lr0.001/checkpoints/checkpoint_best.pt"
export MRL_NMT_EVAL_NAME="newstest2020"
export MRL_NMT_RAW_DATA_FOLDER=/home/$(whoami)/datasets/mrl_nmt22/processed/en-cs/en_sp32k_cs_sp32k/default-train
export MRL_NMT_REFERENCES_FILE=/home/$(whoami)/datasets/mrl_nmt22/processed/en-cs/en_sp32k_cs_sp32k/default-train/en-cs.test.detok.cs

# uncomment to evaluate on WMT-early
#export MRL_NMT_BIN_DATA_FOLDER=/home/$(whoami)/mrl_nmt22/data-bin/en-cs/en_sp32k_cs_sp32k/wmt-early/
#export MRL_NMT_EVAL_MODE="train"
#export MRL_NMT_EVAL_MODEL_CHECKPOINT="/home/jonnesaleva/mrl_nmt22/experiments/en_sp32k_cs_sp32k_slurm_sanevocab/train/slurmformer_clipnorm0.1_20k_lr0.001/checkpoints/checkpoint_best.pt"
#export MRL_NMT_EVAL_NAME="wmt-early"
#export MRL_NMT_RAW_DATA_FOLDER=/home/$(whoami)/datasets/mrl_nmt22/processed/en-cs/en_sp32k_cs_sp32k/wmt-early
#export MRL_NMT_REFERENCES_FILE=/home/$(whoami)/datasets/mrl_nmt22/processed/en-cs/en_sp32k_cs_sp32k/wmt-early/en-cs.train.detok.cs

# uncomment to evaluate on WMT-late
#export MRL_NMT_BIN_DATA_FOLDER=/home/$(whoami)/mrl_nmt22/data-bin/en-cs/en_sp32k_cs_sp32k/wmt-late/
#export MRL_NMT_EVAL_MODE="train"
#export MRL_NMT_EVAL_MODEL_CHECKPOINT="/home/jonnesaleva/mrl_nmt22/experiments/en_sp32k_cs_sp32k_slurm_sanevocab/train/slurmformer_clipnorm0.1_20k_lr0.001/checkpoints/checkpoint_best.pt"
#export MRL_NMT_EVAL_NAME="wmt-late"
#export MRL_NMT_RAW_DATA_FOLDER=/home/$(whoami)/datasets/mrl_nmt22/processed/en-cs/en_sp32k_cs_sp32k/wmt-late
#export MRL_NMT_REFERENCES_FILE=/home/$(whoami)/datasets/mrl_nmt22/processed/en-cs/en_sp32k_cs_sp32k/wmt-late/en-cs.train.detok.cs
