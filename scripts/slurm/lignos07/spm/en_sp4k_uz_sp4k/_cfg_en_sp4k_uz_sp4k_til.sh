...
export MRL_NMT_MAX_UPDATES=30000
export MRL_NMT_MODEL_NAME=rtxformer_30k
...
export MRL_NMT_EVAL_MODEL_CHECKPOINT="/home/$(whoami)/mrl_nmt22/experiments/en_sp4k_uz_sp4k_slurm/train/rtxformer_30k/checkpoints/checkpoint_last.pt"
export MRL_NMT_EVAL_MODE="test"
export MRL_NMT_EVAL_NAME="eval_rtxformer_30k"
