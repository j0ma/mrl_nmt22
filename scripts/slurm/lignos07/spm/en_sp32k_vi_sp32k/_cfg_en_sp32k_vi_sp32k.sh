...
export MRL_NMT_EXPERIMENT_NAME=en_sp32k_vi_sp32k_slurm
...
export MRL_NMT_TGT_LANG=vi
export MRL_NMT_VALIDATE_INTERVAL_UPDATES=500 

# corpus: default-train
export MRL_NMT_BIN_DATA_FOLDER=/home/$(whoami)/mrl_nmt22/data-bin/en-vi/en_sp32k_vi_sp32k/default-train/
export MRL_NMT_EVAL_MODE="test"
export MRL_NMT_EVAL_MODEL_CHECKPOINT="/home/$(whoami)/mrl_nmt22/experiments/en_sp32k_vi_sp32k_slurm/train/rtxformer/checkpoints/checkpoint_best.pt"
export MRL_NMT_EVAL_NAME="eval_rtxformer_secondrun_test"
export MRL_NMT_RAW_DATA_FOLDER=/home/$(whoami)/datasets/mrl_nmt22/processed/en-vi/en_sp32k_vi_sp32k/default-train
export MRL_NMT_REFERENCES_FILE=/home/$(whoami)/datasets/mrl_nmt22/processed/en-vi/en_sp32k_vi_sp32k/default-train/en-vi.test.detok.vi

# corpus: opus-100 (uncomment to use this for train/dev/test)
#export MRL_NMT_BIN_DATA_FOLDER=/home/$(whoami)/mrl_nmt22/data-bin/en-vi/en_sp32k_vi_sp32k/opus-100/
#export MRL_NMT_EVAL_MODE="dev"
#export MRL_NMT_EVAL_MODEL_CHECKPOINT="/home/$(whoami)/mrl_nmt22/experiments/en_sp32k_vi_sp32k_slurm/train/rtxformer/checkpoints/checkpoint_best.pt"
#export MRL_NMT_EVAL_NAME="opus-100"
#export MRL_NMT_RAW_DATA_FOLDER=/home/$(whoami)/datasets/mrl_nmt22/processed/en-vi/en_sp32k_vi_sp32k/opus-100
#export MRL_NMT_REFERENCES_FILE=/home/$(whoami)/datasets/mrl_nmt22/processed/en-vi/en_sp32k_vi_sp32k/opus-100/en-vi.dev.detok.vi
