...
export MRL_NMT_EXPERIMENT_NAME=en_spmbart_et_spmbart_slurm
...
export MRL_NMT_TGT_LANG=et
export MRL_NMT_VALIDATE_INTERVAL_UPDATES=500 

# corpus: default-train
export MRL_NMT_BIN_DATA_FOLDER=/home/jonnesaleva/mrl_nmt22/data-bin/en-et/en_spmbart_et_spmbart/default-train/
export MRL_NMT_EVAL_MODE="test"
export MRL_NMT_EVAL_MODEL_CHECKPOINT="/home/jonnesaleva/mrl_nmt22/experiments/en_spmbart_et_spmbart_slurm/train/slurmformer_clipnorm0.1_20k_lr0.001/checkpoints/checkpoint_best.pt"
export MRL_NMT_EVAL_NAME="eval_slurmformer_clipnorm0.1_20k_lr0.001"
export MRL_NMT_RAW_DATA_FOLDER=/home/jonnesaleva/datasets/mrl_nmt22/processed/en-et/en_spmbart_et_spmbart/default-train
export MRL_NMT_REFERENCES_FILE=/home/jonnesaleva/datasets/mrl_nmt22/processed/en-et/en_spmbart_et_spmbart/default-train/en-et.test.detok.et
