...
export MRL_NMT_EXPERIMENT_NAME=en_bpe1k_iu_bpe1k_slurm
...
export MRL_NMT_MODEL_NAME=rtxformer_largeinitlr
...
export MRL_NMT_TGT_LANG=iu
export MRL_NMT_VALIDATE_INTERVAL_UPDATES=500 

# corpus: hansard
export MRL_NMT_BIN_DATA_FOLDER=/home/$(whoami)/mrl_nmt22/data-bin/en-iu/en_bpe1k_iu_bpe1k/hansard/
export MRL_NMT_EVAL_MODE="test"
export MRL_NMT_EVAL_MODEL_CHECKPOINT="/home/$(whoami)/mrl_nmt22/experiments/en_bpe1k_iu_bpe1k_slurm/train/rtxformer_largeinitlr/checkpoints/checkpoint_best.pt"
export MRL_NMT_EVAL_NAME="eval_rtxformer_largeinitlr_rtx3090_early"
export MRL_NMT_RAW_DATA_FOLDER=/home/$(whoami)/datasets/mrl_nmt22/processed/en-iu/en_bpe1k_iu_bpe1k/hansard
export MRL_NMT_REFERENCES_FILE=/home/$(whoami)/datasets/mrl_nmt22/processed/en-iu/en_bpe1k_iu_bpe1k/hansard/en-iu.test.detok.iu

# uncomment to evaluate on WMT2020
#export MRL_NMT_BIN_DATA_FOLDER=/home/$(whoami)/mrl_nmt22/data-bin/en-iu/en_bpe1k_iu_bpe1k/wmt20/
#export MRL_NMT_EVAL_MODE="dev"
#export MRL_NMT_EVAL_MODEL_CHECKPOINT="/home/$(whoami)/mrl_nmt22/experiments/en_bpe1k_iu_bpe1k_slurm/train/rtxformer_largeinitlr/checkpoints/checkpoint_best.pt"
#export MRL_NMT_EVAL_NAME="wmt20_early_0126220_1159"
#export MRL_NMT_RAW_DATA_FOLDER=/home/$(whoami)/datasets/mrl_nmt22/processed/en-iu/en_bpe1k_iu_bpe1k/wmt20
#export MRL_NMT_REFERENCES_FILE=/home/$(whoami)/datasets/mrl_nmt22/processed/en-iu/en_bpe1k_iu_bpe1k/wmt20/en-iu.dev.detok.iu
