...
export MRL_NMT_EXPERIMENT_NAME=en_sp32k_iu_sp32k_slurm
...
# corpus: hansard
export MRL_NMT_BIN_DATA_FOLDER=/home/$(whoami)/mrl_nmt22/data-bin/en-iu/en_sp32k_iu_sp32k/hansard/
export MRL_NMT_EVAL_MODE="test"
export MRL_NMT_EVAL_MODEL_CHECKPOINT="/home/$(whoami)/mrl_nmt22/experiments/en_sp32k_iu_sp32k_slurm/train/rtxformer/checkpoints/checkpoint_best.pt"
export MRL_NMT_EVAL_NAME="eval_rtxformer"
export MRL_NMT_RAW_DATA_FOLDER=/home/$(whoami)/datasets/mrl_nmt22/processed/en-iu/en_sp32k_iu_sp32k/hansard
export MRL_NMT_REFERENCES_FILE=/home/$(whoami)/datasets/mrl_nmt22/processed/en-iu/en_sp32k_iu_sp32k/hansard/en-iu.dev.detok.iu

# uncomment to evaluate on WMT2020
#export MRL_NMT_BIN_DATA_FOLDER=/home/$(whoami)/mrl_nmt22/data-bin/en-iu/en_sp32k_iu_sp32k/wmt20/
#export MRL_NMT_EVAL_MODE="dev"
#export MRL_NMT_EVAL_MODEL_CHECKPOINT="/home/$(whoami)/mrl_nmt22/experiments/en_sp32k_iu_sp32k_slurm/train/rtxformer/checkpoints/checkpoint_best.pt"
#export MRL_NMT_EVAL_NAME="wmt20"
#export MRL_NMT_RAW_DATA_FOLDER=/home/$(whoami)/datasets/mrl_nmt22/processed/en-iu/en_sp32k_iu_sp32k/wmt20
#export MRL_NMT_REFERENCES_FILE=/home/$(whoami)/datasets/mrl_nmt22/processed/en-iu/en_sp32k_iu_sp32k/wmt20/en-iu.dev.detok.iu
