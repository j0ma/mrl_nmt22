...
# NOTE: taken from https://anon.to/ei7A1x
...
if __name__ == "__main__":
    ...
    # open output files
    srcout = codecs.open("%s.%s" % (options.base, options.srclang), "w", "utf-8")
    tgtout = codecs.open("%s.%s" % (options.base, options.tgtlang), "w", "utf-8")
